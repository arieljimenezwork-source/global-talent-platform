...
Tener la entrevista (video).

Anotar tus impresiones.
...
Abre tu correo personal.

Redacta un email para la dirección que configuraste en el sistema (GMAIL_USER).

Asunto: "Postulación Desarrollador Frontend".

Adjunto: Sube cualquier PDF que parezca un CV.

Enviar.

Paso 3: Ver la Magia
Espera 2 minutos (el mozo revisa el correo cada 120 segundos).

Mira la consola de tu terminal. Deberías ver: 📨 Correo recibido... Procesando CV....

Refresca el Dashboard (http://localhost:3001).

¡Ahí está! Tu candidato debería aparecer en la columna "Nuevos" con un Score asignado.

Paso 4: Tomar el Control
Haz clic en "Aprobar". Verás cómo salta a la pestaña "Gestión".

Haz clic en "Analizar con IA" (simulando que ya hubo entrevista).

Espera unos segundos y descarga el DOCX generado. ¡Ábrelo y sorpréndete!
